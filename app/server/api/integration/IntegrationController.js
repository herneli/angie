...
export class IntegrationController extends BaseController {
    ...
    configure() {
        ...
        this.router.get(`/integration/list/full`, asyncHandler((request, response, next) => { this.integrationsWithChannels(request, response, next); }));

        this.router.post(`/integration/:id/deploy`, asyncHandler((request, response, next) => { this.deployIntegration(request, response, next); }));
        this.router.post(`/integration/:id/undeploy`, asyncHandler((request, response, next) => { this.undeployIntegration(request, response, next); }));
