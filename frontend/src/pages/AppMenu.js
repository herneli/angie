...
import { HomeOutlined, BranchesOutlined, UserOutlined } from '@ant-design/icons'
    ...
    return (
        <Menu onClick={(e) => changeSelection(e.key)} selectedKeys={[selected]} mode="horizontal">
            ...
            {keycloak && !keycloak.authenticated &&
                <Menu.Item key="login" className="rightFloated" icon={<UserOutlined />}>
            ...
            {keycloak && keycloak.authenticated &&
                <Menu.Item key="logout" className="rightFloated" icon={<UserOutlined />}>
