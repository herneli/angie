...
const TranslationLoader = {
    ...
    loadTranslations: async (callback) => {
        ...
        try {
            ...
            let fallbackObj;
            if (lang !== fallback) { //Si son la misma, no se obtiene y listo, ahorramos una llamada
            ...
            T.setTexts(result.data.data[0].items, {
                notFound: (key) => {
                    if (key && fallbackObj && fallbackObj.data && fallbackObj.data.data[0]) {
